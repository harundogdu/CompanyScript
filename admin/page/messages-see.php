<?php $lastMessages = $database->getData("messages", 1, " WHERE messages_see=1 ORDER BY messages_id DESC"); ?>
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <div class="row">
                <div class="col-md-12">
                    <h2 style="margin-bottom: 20px !important;">Okunmuş Mesajlar</h2>
                </div>
            </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td colspan="5">
                                                <div class="alert alert-warning text-center"> Okunmuş Mesaj Yok </div>
                                            </td>
                                        </tr>';
                                        <?php
                                    else :
